...
@section('admin-title','Edit Attribute - ' . $product->name)
...
<div class="container-fluid">
    <div class="row">
        <div class="col-md-8 m-auto">
            <div class="card">
                <div class="card-body">
                    <form id="attribute-form" method="POST" action="{{ route('products.attributes.update', [$product, $attribute]) }}">
                        @csrf
                        @method('PUT')
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="attribute_name" name="attribute_name" placeholder="e.g., Material, Weight, Ingredients" value="{{ old('attribute_name', $attribute->attribute_name) }}">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control" id="attribute_value" name="attribute_value" rows="1" placeholder="e.g., 100% Cotton, 250g">{{ old('attribute_value', $attribute->attribute_value) }}</textarea>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="attribute_group" name="attribute_group" placeholder="e.g., Technical Specs, Features" value="{{ old('attribute_group', $attribute->attribute_group) }}">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control" id="sort_order" name="sort_order" placeholder="0" min="0" value="{{ old('sort_order', $attribute->sort_order) }}">
                        ...
                        <button type="submit" class="btn btn-primary">{{ __('Update Attribute') }}</button>
