...
<head>
    ...
    <title>@yield('auth-title','Sajid Beauty BD')</title>
	...
	<!-- slick icon-->
    <link rel="stylesheet" type="text/css" href="{{ asset('admin_asset/css/vendors/slick.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ asset('admin_asset/css/vendors/slick-theme.css') }}">
...
<body>
		...
		c1.923,0,3.84-0.728,5.303-2.192l-83.142-83.142L393.695,417.909z" />
                            ...
                            <div class="single-item">
                                <div>
                                    <div>
                                        <h3>Welcome Back!</h3>
                                        <p>Sajid Beauty BD is a beauty and cosmetics shop located at Shop No-95, Ground Floor, Shimanto Shambar Shopping Mall, Dhaka-1205.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <!-- feather icon js-->
    <script src="{{ asset('admin_asset/js/icons/feather-icon/feather.min.js') }}"></script>
    <script src="{{ asset('admin_asset/js/icons/feather-icon/feather-icon.js') }}"></script>
    <!-- Sidebar jquery-->
    <script src="{{ asset('admin_asset/js/sidebar-menu.js') }}"></script>
    <script src="{{ asset('admin_asset/js/slick.js') }}"></script>
	
    <!-- lazyload js-->
    <script src="{{ asset('admin_asset/js/lazysizes.min.js') }}"></script>
    <!--right sidebar js-->
    <script src="assets/js/chat-menu.js"></script>
   
    <!--script admin-->
    <script src="{{ asset('admin_asset/js/admin-script.js') }}"></script>
	<script>
        $('.single-item').slick({
            arrows: false,
            dots: true
