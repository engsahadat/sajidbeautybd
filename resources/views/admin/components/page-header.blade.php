    ...
    <div class="main-header-right row">
        <div class="main-header-left d-lg-none w-auto">
            <div class="logo-wrapper">
                <a href="{{ route('home') }}">
                    <img class="blur-up lazyloaded d-block d-lg-none" src="{{ asset('admin_asset/images/dashboard/multikart-logo-black.png') }}" alt="">
                </a>
            </div>
        </div>
                ...
                <li class="onhover-dropdown">
                    <div class="media align-items-center">
                        <img class="align-self-center pull-right img-50 blur-up lazyloaded"
                            src="{{ asset('admin_asset/images/dashboard/user3.jpg') }}" alt="header-user">
