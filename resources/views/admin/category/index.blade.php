                                ...
                                <tbody>
                                    @foreach ($categories as $category)
                                        <tr>
                                            ...
                                            <td>
                                                @if($category->image)
                                                    <img src="{{ asset($category->image) }}" data-field="image" alt="" style="width: 50px; height: 50px; object-fit: cover;">
                                                @else
                                                    <img src="{{ asset('images/default-image.png') }}" data-field="image" alt="" style="width: 50px; height: 50px; object-fit: cover;">
                                                @endif
                                            </td>
