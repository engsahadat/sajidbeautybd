      ...
      <a href="{{ route('admin.reports.sales') }}" class="text-decoration-none">
        <div class="card border-primary">
          <div class="card-body text-center">
            ...
            <p class="text-muted small mb-0">View detailed sales analytics by period</p>
          </div>
        </div>
      </a>
    </div>
      ...
      <a href="{{ route('admin.reports.products') }}" class="text-decoration-none">
        <div class="card border-success">
          <div class="card-body text-center">
            ...
            <h5 class="mt-2">Product Report</h5>
            <p class="text-muted small mb-0">Top products and inventory insights</p>
          </div>
        </div>
      </a>
    </div>
      ...
      <a href="{{ route('admin.reports.customers') }}" class="text-decoration-none">
        <div class="card border-info">
          <div class="card-body text-center">
            ...
            <p class="text-muted small mb-0">Customer behavior and top buyers</p>
          </div>
        </div>
      </a>
    </div>
      ...
      <a href="{{ route('admin.reports.payments') }}" class="text-decoration-none">
        <div class="card border-warning">
          <div class="card-body text-center">
            ...
            <h5 class="mt-2">Payment Report</h5>
            <p class="text-muted small mb-0">Payment gateway and transaction details</p>
          </div>
        </div>
      </a>
    </div>
      ...
      <a href="{{ route('admin.reports.orders') }}" class="text-decoration-none">
        <div class="card border-danger">
          <div class="card-body text-center">
            ...
            <h5 class="mt-2">Order Report</h5>
            <p class="text-muted small mb-0">Order status breakdown and trends</p>
          </div>
        </div>
      </a>
    </div>
