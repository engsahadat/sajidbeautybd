...
<div class="container-fluid">
    <div class="page-header">
        <div class="row">
            <div class="col-lg-6"><div class="page-header-left"><h3>{{ __('Create Product') }}</h3></div></div>
            <div class="col-lg-6">
            ...
            <div class="card"><div class="card-body">
                <form id="product-form" method="POST" action="{{ route('products.store') }}" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                <label for="slug" class="form-label">{{ __('Slug') }} <small class="text-muted">({{ __('auto if empty') }})</small></label>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <input type="number" step="0.01" id="price" name="price" class="form-control" value="{{ old('price', 0) }}">
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <input type="number" step="0.01" id="sale_price" name="sale_price" class="form-control" value="{{ old('sale_price') }}">
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <input type="number" id="stock_quantity" name="stock_quantity" class="form-control" value="{{ old('stock_quantity', 0) }}">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <input type="text" id="dimensions" name="dimensions" class="form-control" value="{{ old('dimensions') }}" placeholder="LxWxH or custom">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="description" id="description" class="form-control rich-text" rows="6">{{ old('description') }}</textarea>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="short_description" id="short_description" class="form-control rich-text" rows="4">{{ old('short_description') }}</textarea>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="highlight" id="highlight" class="form-control rich-text" rows="6" placeholder="One per line or paragraph">{{ old('highlight') }}</textarea>
                        <div class="form-text">Use bullet-like lines for features. You can format on the front-end.</div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" name="remark" id="remark" class="form-control" value="{{ old('remark') }}" placeholder="e.g., Paraben Free, Alcohol-Free">
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" name="country_of_origin" id="country_of_origin" class="form-control" value="{{ old('country_of_origin') }}" placeholder="e.g., Taiwan">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <div class="text-danger d-none error-message" id="gallery-error"></div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-check mt-4">
                                ...
                                <div class="text-danger d-none error-message" id="is_featured-error"></div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="d-flex justify-content-between">
                        ...
                        <div>
                            ...
                            <button id="product-submit" type="submit" class="btn btn-primary"><i class="fa fa-floppy-o"></i> {{ ('Save Product') }}</button>
                        </div>
                    </div>
                </form>
            </div>
...
$(document).ready(function() {
    // Init Summernote for all .rich-text textareas
    if ($.fn.summernote) {
    ...
    $('#product-form').on('submit', function(e) {
        // Ensure Summernote editor values are synced back to textareas
        if ($.fn.summernote) {
            ...
            reader.onload = function(e) {
                ...
                const preview = `
                    <div class="image-preview mt-2">
                        ...
                        <button type="button" class="btn btn-sm mt-1 remove-preview">X</button>
                    </div>
                `;
            ...
            reader.onload = function(e){
                const item = `
                    <div class="gallery-item position-relative" data-index="${idx}">
                        ...
                        <button type="button" class="btn btn-sm position-absolute remove-gallery" style="top:-8px; right:-8px;">&times;</button>
                    </div>`;
                $wrap.append(item);
            };
            reader.readAsDataURL(file);
...
$('#product-submit').click(function (e) {
    ...
    $('#product-submit').html(spinner);
    $('.error-message').addClass('d-none').html('');

    axios.post("{{ route('products.store') }}", formData, { headers: { 'Content-Type': 'multipart/form-data', 'X-CSRF-TOKEN': '{{ csrf_token() }}' } })
    .then(response => {
    ...
    .catch(error => {
        if (error.response && error.response.status === 422) {
            ...
            Object.keys(errors).forEach((field) => {
                // Normalize keys like 'gallery.0' or 'gallery[0]' to 'gallery'
                const base = field.replace(/\..*$/, '').replace(/\[\d+\]/g, '');
                const targetId = `#${base}-error`;
    ...
    .finally(() => { $('#product-submit').html('<i class="fa fa-floppy-o"></i> Save Product'); });
});
</script>
@endpush