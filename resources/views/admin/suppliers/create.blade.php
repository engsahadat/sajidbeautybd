...
@section('admin-title','Create Supplier')
                    ...
                    <form id="supplier-form" method="POST" action="{{ route('suppliers.store') }}">
                        ...
                        <div class="row g-3">
                            <div class="col-md-4">
                                ...
                                <select class="form-select" id="product_id" name="product_id">
                                    ...
                                    @foreach($products as $pid => $pname)
                                        <option value="{{ $pid }}" {{ old('product_id') == $pid ? 'selected' : '' }}>{{ $pname }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-md-4">
                                ...
                                <select class="form-select" id="vendor_id" name="vendor_id">
                                    ...
                                    @foreach($vendors as $vid => $vname)
                                        <option value="{{ $vid }}" {{ old('vendor_id') == $vid ? 'selected' : '' }}>{{ __('Vendor') }} #{{ $vname }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-md-4">
                                ...
                                <input class="form-control" id="supplier_sku" name="supplier_sku" maxlength="50" placeholder="Enter supplier SKU" value="{{ old('supplier_sku') }}">
                            ...
                            <div class="col-md-3">
                                ...
                                <input class="form-control" id="cost_price" type="number" step="0.01" min="0" name="cost_price" placeholder="0.00" value="{{ old('cost_price') }}">
                            ...
                            <div class="col-md-3">
                                ...
                                <input class="form-control" id="minimum_order_quantity" type="number" min="1" name="minimum_order_quantity" placeholder="1" value="{{ old('minimum_order_quantity', 1) }}">
                            ...
                            <div class="col-md-3">
                                ...
                                <input class="form-control" id="lead_time_days" type="number" min="0" name="lead_time_days" placeholder="0" value="{{ old('lead_time_days', 0) }}">
                                <div class="text-danger d-none error-message" id="lead_time_days-error"></div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-check mt-4">
                                    <input class="form-check-input" type="checkbox" name="is_primary" value="1" id="is_primary" {{ old('is_primary') ? 'checked' : '' }}>
                        ...
                        <div class="d-flex justify-content-between mt-3">
                            ...
                            <div>
                                ...
                                <button id="supplier-submit" type="button" class="btn btn-primary">
                                    <i class="fa fa-floppy-o"></i> {{ __('Save Supplier') }}
                                </button>
                            </div>
                        </div>
                    </form>
...
$('#supplier-submit').click(function (e) {
    ...
    .finally(() => {
        $('#supplier-submit').html('<i class="fa fa-floppy-o"></i> {{ __("Save Supplier") }}');
    });
});
</script>
@endpush