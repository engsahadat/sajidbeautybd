...
<head>
    ...
    <title>Sajib Beauty BD</title>

    <meta name="author" content="http://www.sajidbeautybd.com/">
    <meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1">
    <meta name="description" content="Sajib Beauty BD - Your one-stop solution for beauty products">
                ...
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        <div class="wrap-slider">
                            <img src="{{ asset('assets/images/slider/slider-women1.jpg') }}" alt="fashion-slideshow">
                            <div class="box-content">
                                <div class="content-slider">
                                    <div class="box-title-slider">
                                        <p class="fade-item fade-item-1 subheading text-btn-uppercase text-white">
                                            BIKINIS & SWIMSUITS</p>
                                        <div class="fade-item fade-item-2 heading text-white title-display">Flash Sale
                                            Madness</div>
                                    </div>
                    ...
                    <div class="swiper-slide">
                        <div class="wrap-slider">
                            <img src="{{ asset('assets/images/slider/slider-women2.jpg') }}" alt="fashion-slideshow">
                            <div class="box-content">
                                <div class="content-slider">
                                    <div class="box-title-slider">
                                        <p class="fade-item fade-item-1 subheading text-btn-uppercase text-white">
                                            BIKINIS & SWIMSUITS</p>
                                        <div class="fade-item fade-item-2 heading text-white title-display">Find Your
                                            <br> Signature Style
                                        </div>
                                    </div>
                                    <div class="fade-item fade-item-3 box-btn-slider">
            ...
            <div class="container">
                ...
                <div class="flat-collection-circle wow fadeInUp" data-wow-delay="0.1s">
                    <div dir="ltr" class="swiper tf-sw-collection" data-preview="5" data-tablet="3" data-mobile="2"
                        ...
                        <div class="swiper-wrapper">
                            ...
                            <div class="swiper-slide">
                                <div class="collection-circle hover-img">
                                    <a href="shop-collection.html" class="img-style">
                                        <img class="lazyload"
                                            data-src="{{ asset('assets/images/collections/collection-circle/cls-circle1.jpg') }}"
                                            src="{{ asset('assets/images/collections/collection-circle/cls-circle1.jpg') }}"
                                            alt="collection-img">
                                    </a>
                            ...
                            <div class="swiper-slide">
                                <div class="collection-circle hover-img">
                                    <a href="shop-collection.html" class="img-style">
                                        <img class="lazyload"
                                            data-src="{{ asset('assets/images/collections/collection-circle/cls-circle2.jpg') }}"
                                            src="{{ asset('assets/images/collections/collection-circle/cls-circle2.jpg') }}"
                                            alt="collection-img">
                                    </a>
                                    <div class="collection-content text-center">
                                        <div>
                            ...
                            <div class="swiper-slide">
                                <div class="collection-circle hover-img">
                                    <a href="shop-collection.html" class="img-style">
                                        <img class="lazyload"
                                            data-src="{{ asset('assets/images/collections/collection-circle/cls-circle3.jpg') }}"
                                            src="{{ asset('assets/images/collections/collection-circle/cls-circle3.jpg') }}"
                                            alt="collection-img">
                                    </a>
                                    <div class="collection-content text-center">
                                        <div>
                            ...
                            <div class="swiper-slide">
                                <div class="collection-circle hover-img">
                                    <a href="shop-collection.html" class="img-style">
                                        <img class="lazyload"
                                            data-src="{{ asset('assets/images/collections/collection-circle/cls-circle4.jpg') }}"
                                            src="{{ asset('assets/images/collections/collection-circle/cls-circle4.jpg') }}"
                                            alt="collection-img">
                                    </a>
                                    <div class="collection-content text-center">
                                        <div>
                            ...
                            <div class="swiper-slide">
                                <div class="collection-circle hover-img">
                                    <a href="shop-collection.html" class="img-style">
                                        <img class="lazyload"
                                            data-src="{{ asset('assets/images/collections/collection-circle/cls-circle5.jpg') }}"
                                            src="{{ asset('assets/images/collections/collection-circle/cls-circle5.jpg') }}"
                                            alt="collection-img">
                                    </a>
                                    <div class="collection-content text-center">
                                        <div>
                        ...
                        <div
                            class="d-flex d-lg-none sw-pagination-collection sw-dots type-circle justify-content-center">
                        </div>
                    </div>
                            ...
                            <div class="tf-grid-layout tf-col-2 lg-col-3 xl-col-4">
                                    ...
                                    <div class="card-product-wrapper">
                                        <a href="product-detail.html" class="product-img">
                                            <img class="lazyload img-product"
                                                data-src="{{ asset('assets/images/products/womens/women-19.jpg') }}"
                                                src="{{ asset('assets/images/products/womens/women-19.jpg') }}"
                                                alt="image-product">
                                            <img class="lazyload img-hover"
                                                data-src="{{ asset('assets/images/products/womens/women-20.jpg') }}"
                                                src="{{ asset('assets/images/products/womens/women-20.jpg') }}"
                                                alt="image-product">
                                        </a>
                                ...
                                <div class="card-product wow fadeInUp" data-wow-delay="0.1s">
                                    <div class="card-product-wrapper">
                                        <a href="product-detail.html" class="product-img">
                                            <img class="lazyload img-product"
                                                data-src="{{ asset('assets/images/products/womens/women-176.jpg') }}"
                                                src="{{ asset('assets/images/products/womens/women-176.jpg') }}"
                                                alt="image-product">
                                            <img class="lazyload img-hover"
                                                data-src="{{ asset('assets/images/products/womens/women-179.jpg') }}"
                                                src="{{ asset('assets/images/products/womens/women-179.jpg') }}"
                                                alt="image-product">
                                        </a>
                                    ...
                                    <div class="card-product-info">
                                        ...
                                        <ul class="list-color-product">
                                            ...
                                            <li class="list-color-item color-swatch">
                                                ...
                                                <img class="lazyload"
                                                    data-src="{{ asset('assets/images/products/womens/women-177.jpg') }}"
                                                    src="{{ asset('assets/images/products/womens/women-177.jpg') }}"
                                                    alt="image-product">
                                            </li>
                                        </ul>
                                    </div>
                                ...
                                <div class="card-product card-product-size wow fadeInUp" data-wow-delay="0.2s">
                                    <div class="card-product-wrapper">
                                        <a href="product-detail.html" class="product-img">
                                            <img class="lazyload img-product"
                                                data-src="{{ asset('assets/images/products/womens/women-29.jpg') }}"
                                                src="{{ asset('assets/images/products/womens/women-29.jpg') }}"
                                                alt="image-product">
                                            <img class="lazyload img-hover"
                                                data-src="{{ asset('assets/images/products/womens/women-30.jpg') }}"
                                                src="{{ asset('assets/images/products/womens/women-30.jpg') }}"
                                                alt="image-product">
                                        </a>
                                    ...
                                    <div class="card-product-info">
                                        ...
                                        <ul class="list-color-product">
                                            ...
                                            <li class="list-color-item color-swatch">
                                                ...
                                                <img class="lazyload"
                                                    data-src="{{ asset('assets/images/products/womens/women-33.jpg') }}"
                                                    src="{{ asset('assets/images/products/womens/women-33.jpg') }}"
                                                    alt="image-product">
                                            </li>
                                ...
                                <div class="card-product wow fadeInUp" data-wow-delay="0.3s">
                                    <div class="card-product-wrapper">
                                        <a href="product-detail.html" class="product-img">
                                            <img class="lazyload img-product"
                                                data-src="{{ asset('assets/images/products/womens/women-1.jpg') }}"
                                                src="{{ asset('assets/images/products/womens/women-1.jpg') }}"
                                                alt="image-product">
                                            <img class="lazyload img-hover"
                                                data-src="{{ asset('assets/images/products/womens/women-2.jpg') }}"
                                                src="{{ asset('assets/images/products/womens/women-2.jpg') }}"
                                                alt="image-product">
                                        </a>
                                        <div class="list-product-btn">
                                            <a href="javascript:void(0);" class="box-icon wishlist btn-icon-action">
                                    ...
                                    <div class="card-product-info">
                                        ...
                                        <ul class="list-color-product">
                                            ...
                                            <li class="list-color-item color-swatch">
                                                ...
                                                <img class="lazyload"
                                                    data-src="{{ asset('assets/images/products/womens/women-3.jpg') }}"
                                                    src="{{ asset('assets/images/products/womens/women-3.jpg') }}"
                                                    alt="image-product">
                                            </li>
                                        </ul>
                                    </div>
                                ...
                                <div class="card-product card-product-size wow fadeInUp">
                                    <div class="card-product-wrapper">
                                        <a href="product-detail.html" class="product-img">
                                            <img class="lazyload img-product"
                                                data-src="{{ asset('assets/images/products/womens/women-8.jpg') }}"
                                                src="{{ asset('assets/images/products/womens/women-8.jpg') }}"
                                                alt="image-product">
                                            <img class="lazyload img-hover"
                                                data-src="{{ asset('assets/images/products/womens/women-9.jpg') }}"
                                                src="{{ asset('assets/images/products/womens/women-9.jpg') }}"
                                                alt="image-product">
                                        </a>
                                        <div class="variant-wrap size-list">
                                            <ul class="variant-box">
                                ...
                                <div class="card-product wow fadeInUp" data-wow-delay="0.1s">
                                    <div class="card-product-wrapper">
                                        <a href="product-detail.html" class="product-img">
                                            <img class="lazyload img-product"
                                                data-src="{{ asset('assets/images/products/womens/women-171.jpg') }}"
                                                src="{{ asset('assets/images/products/womens/women-171.jpg') }}"
                                                alt="image-product">
                                            <img class="lazyload img-hover"
                                                data-src="{{ asset('assets/images/products/womens/women-172.jpg') }}"
                                                src="{{ asset('assets/images/products/womens/women-172.jpg') }}"
                                                alt="image-product">
                                        </a>
                                ...
                                <div class="card-product card-product-size wow fadeInUp" data-wow-delay="0.2s">
                                    <div class="card-product-wrapper">
                                        <a href="product-detail.html" class="product-img">
                                            <img class="lazyload img-product"
                                                data-src="{{ asset('assets/images/products/womens/women-83.jpg') }}"
                                                src="{{ asset('assets/images/products/womens/women-83.jpg') }}"
                                                alt="image-product">
                                            <img class="lazyload img-hover"
                                                data-src="{{ asset('assets/images/products/womens/women-84.jpg') }}"
                                                src="{{ asset('assets/images/products/womens/women-84.jpg') }}"
                                                alt="image-product">
                                        </a>
                                        <div class="on-sale-wrap"><span class="on-sale-item">-25%</span></div>
                                        <div class="variant-wrap size-list">
                                    ...
                                    <div class="card-product-info">
                                        ...
                                        <ul class="list-color-product">
                                            ...
                                            <li class="list-color-item color-swatch">
                                                ...
                                                <img class="lazyload"
                                                    data-src="{{ asset('assets/images/products/womens/women-94.jpg') }}"
                                                    src="{{ asset('assets/images/products/womens/women-94.jpg') }}"
                                                    alt="image-product">
                                            </li>
                                            <li class="list-color-item color-swatch line">
                                                <span class="swatch-value bg-white"></span>
                                                <img class="lazyload"
                                                    data-src="{{ asset('assets/images/products/womens/women-87.jpg') }}"
                                                    src="{{ asset('assets/images/products/womens/women-87.jpg') }}"
                                                    alt="image-product">
                                            </li>
                                        </ul>
                                    </div>
                                ...
                                <div class="card-product card-product-size wow fadeInUp" data-wow-delay="0.3s">
                                    <div class="card-product-wrapper">
                                        <a href="product-detail.html" class="product-img">
                                            <img class="lazyload img-product"
                                                data-src="{{ asset('assets/images/products/womens/women-102.jpg') }}"
                                                src="{{ asset('assets/images/products/womens/women-102.jpg') }}"
                                                alt="image-product">
                                            <img class="lazyload img-hover"
                                                data-src="{{ asset('assets/images/products/womens/women-103.jpg') }}"
                                                src="{{ asset('assets/images/products/womens/women-103.jpg') }}"
                                                alt="image-product">
                                        </a>
                                        <div class="on-sale-wrap"><span class="on-sale-item">-25%</span></div>
                                        <div class="variant-wrap size-list">
                                    ...
                                    <div class="card-product-info">
                                        ...
                                        <ul class="list-color-product">
                                            ...
                                            <li class="list-color-item color-swatch">
                                                <span class="swatch-value bg-light-orange"></span>
                                                <img class="lazyload"
                                                    data-src="{{ asset('assets/images/products/womens/women-111.jpg') }}"
                                                    src="{{ asset('assets/images/products/womens/women-111.jpg') }}"
                                                    alt="image-product">
                                            </li>
                                            <li class="list-color-item color-swatch line">
                                                <span class="swatch-value bg-white"></span>
                                                <img class="lazyload"
                                                    data-src="{{ asset('assets/images/products/womens/women-104.jpg') }}"
                                                    src="{{ asset('assets/images/products/womens/women-104.jpg') }}"
                                                    alt="image-product">
                                            </li>
                                        </ul>
                                    </div>
            ...
            <div class="container">
                <div class="tf-grid-layout md-col-2">
                    <div class="collection-default hover-img">
                        <a class="img-style">
                            <img class="lazyload"
                                data-src="{{ asset('assets/images/collections/banner-collection/banner-cls1.jpg') }}"
                                src="{{ asset('assets/images/collections/banner-collection/banner-cls1.jpg') }}"
                                alt="banner-cls">
                        </a>
                        <div class="content">
                            <h3 class="title wow fadeInUp"><a href="shop-collection.html" class="link">Crossbody bag</a>
                            </h3>
                    ...
                    <div class="collection-position hover-img">
                        <a class="img-style">
                            <img class="lazyload"
                                data-src="{{ asset('assets/images/collections/banner-collection/banner-cls2.jpg') }}"
                                src="{{ asset('assets/images/collections/banner-collection/banner-cls2.jpg') }}"
                                alt="banner-cls">
                        </a>
                        <div class="content">
                            <h3 class="title"><a href="shop-collection.html"
                                    class="link text-white wow fadeInUp">Capsule Collection</a></h3>
                    ...
                    <div class="col-lg-5">
                        <div class="banner-left">
                            <div class="box-title">
                                ...
                                <p class="text-secondary wow fadeInUp">Up to 50% Off Selected Styles. Don't Miss Out.
                                </p>
                            </div>
                            <div class="btn-banner wow fadeInUp">
                                <a href="shop-default-grid.html" class="tf-btn btn-fill"><span class="text">Shop
                                        Now</span><i class="icon icon-arrowUpRight"></i></a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-2">
                        <div class="banner-img">
                            <img class="lazyload" data-src="{{ asset('assets/images/banner/img-countdown1.png') }}"
                                src="{{ asset('assets/images/banner/img-countdown1.png') }}" alt="banner">
                        </div>
                    </div>
                    <div class="col-lg-5">
        ...
        <section class="flat-spacing">
            <div class="container">
                <div class="heading-section text-center">
                    ...
                    <p class="subheading wow fadeInUp">Our customers adore our products, and we constantly aim to
                        delight them.</p>
                </div>
                <div dir="ltr" class="swiper tf-sw-testimonial" data-preview="2" data-tablet="1.3" data-mobile="1"
                    ...
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <div class="testimonial-item hover-img">
                                <div class="img-style">
                                    <img data-src="{{ asset('assets/images/testimonial/tes-1.jpg') }}"
                                        src="{{ asset('assets/images/testimonial/tes-1.jpg') }}" alt="img-testimonial">
                                ...
                                <div class="content">
                                    <div class="content-top">
                                        ...
                                        <p class="text-secondary">"Fantastic shop! Great selection, fair prices, and
                                            ...
                                            exceptional, and the prices are very reasonable!"</p>
                                    ...
                                    <div class="box-avt">
                                        <div class="avatar avt-60 round">
                                            <img src="{{ asset('assets/images/avatar/user-4.jpg') }}" alt="avt">
                                        </div>
                                        <div class="box-price">
                        ...
                        <div class="swiper-slide">
                            <div class="testimonial-item hover-img">
                                <div class="img-style">
                                    <img data-src="{{ asset('assets/images/testimonial/tes-2.jpg') }}"
                                        src="{{ asset('assets/images/testimonial/tes-2.jpg') }}" alt="img-testimonial">
                                    <a href="#quickView" data-bs-toggle="modal" class="box-icon hover-tooltip center">
                                        <span class="icon icon-eye"></span>
                                        <span class="tooltip">Quick View</span>
                                    </a>
                                ...
                                <div class="content">
                                    <div class="content-top">
                                        ...
                                        <p class="text-secondary">"I absolutely love this shop! The products are
                                            high-quality and the customer service is excellent. I always leave with
                                            exactly what I need and a smile on my face."</p>
                                        <div class="box-author">
                                    ...
                                    <div class="box-avt">
                                        <div class="avatar avt-60 round">
                                            <img src="{{ asset('assets/images/avatar/user-5.jpg') }}" alt="avt">
                                        </div>
                                        <div class="box-price">
                                            <p class="text-title text-line-clamp-1">Contrasting sheepskin sweatshirt</p>
                                            <div class="text-button price">$60.00</div>
        ...
        <section class="flat-spacing pt-0">
            <div class="container">
                <div class="heading-section text-center">
                    ...
                    <p class="subheading text-secondary wow fadeInUp">Browse our Top Trending: the hottest picks loved
                        by all.</p>
                </div>
                    ...
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <div class="wg-blog style-1 hover-image wow fadeInUp">
                                <div class="image">
                                    <img class="lazyload" data-src="{{ asset('assets/images/blog/blog-grid-1.jpg') }}"
                                        src="{{ asset('assets/images/blog/blog-grid-1.jpg') }}" alt="">
                                </div>
                                <div class="content">
                                    <p class="text-btn-uppercase text-secondary-2">13 August</p>
                                    <div>
                                        <h6 class="title fw-5">
                                            <a class="link" href="blog-detail.html">Top 10 Summer Fashion Trends You
                                                Can't Miss in 2024</a>
                                        </h6>
                                        <div class="body-text">Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                                            In sed vulputate massa.</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="wg-blog style-1 hover-image wow fadeInUp" data-wow-delay="0.1s">
                                <div class="image">
                                    <img class="lazyload" data-src="{{ asset('assets/images/blog/blog-grid-8.jpg') }}"
                                        src="{{ asset('assets/images/blog/blog-grid-8.jpg') }}" alt="">
                                </div>
                                <div class="content">
                                    <p class="text-btn-uppercase text-secondary-2">13 August</p>
                                    <div>
                                        <h6 class="title fw-5">
                                            <a class="link" href="blog-detail.html">How to Effortlessly Style Your
                                                Office Wear for a Modern Look</a>
                                        </h6>
                                        <div class="body-text">Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                                            In sed vulputate massa.</div>
                                    </div>
                        ...
                        <div class="swiper-slide">
                            <div class="wg-blog style-1 hover-image wow fadeInUp" data-wow-delay="0.2s">
                                <div class="image">
                                    <img class="lazyload" data-src="{{ asset('assets/images/blog/blog-grid-6.jpg') }}"
                                        src="{{ asset('assets/images/blog/blog-grid-6.jpg') }}" alt="">
                                </div>
                                <div class="content">
                                    <p class="text-btn-uppercase text-secondary-2">13 August</p>
                                    ...
                                    <div>
                                        <h6 class="title fw-5">
                                            <a class="link" href="blog-detail.html">Sustainable Fashion: Eco-Friendly
                                                Brands to Watch This Year</a>
                                        </h6>
                                        <div class="body-text">Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                                            In sed vulputate massa.</div>
                                    </div>
                            ...
                            <div class="col-lg-4">
                                <div class="footer-infor">
                                    <div class="footer-logo">
                                        <a href="{{ url('/') }}">
                                            {{-- <h3 class="mb-0">Sajid Beauty BD</h3> --}}
                                            <img style="width: 220px" src="{{ asset('assets/images/logo/footer-logo.png') }}" alt="">
                                        </a>
                                    </div>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="footer-bottom-wrap">
                                    <div class="left">
                                        <p class="text-caption-1">©2025 Sajidbeautybd. All Rights Reserved.</p>
                                    </div>
                                    <div class="tf-payment">
                                        <p class="text-caption-1">Payment:</p>
                                        <ul>
                                            <li>
                                                <img src="{{ asset('assets/images/payment/img-1.png') }}" alt="">
                                            </li>
                                            <li>
                                                <img src="{{ asset('assets/images/payment/img-2.png') }}" alt="">
                                            </li>
                                            <li>
                                                <img src="{{ asset('assets/images/payment/img-3.png') }}" alt="">
                                            </li>
                                            <li>
                                                <img src="{{ asset('assets/images/payment/img-4.png') }}" alt="">
                                            </li>
                                            <li>
                                                <img src="{{ asset('assets/images/payment/img-5.png') }}" alt="">
                                            </li>
                                            <li>
                                                <img src="{{ asset('assets/images/payment/img-6.png') }}" alt="">
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                    ...
                    <div class="tf-grid-layout tf-col-2 lg-col-3 xl-col-4 loadmore-item" data-display="4"
                        ...
                        <div class="fl-item card-product">
                            <div class="card-product-wrapper">
                                <a href="product-detail.html" class="product-img">
                                    <img class="lazyload img-product"
                                        data-src="{{ asset('assets/images/products/mens/men-11.jpg') }}"
                                        src="{{ asset('assets/images/products/mens/men-11.jpg') }}" alt="image-product">
                                    <img class="lazyload img-hover"
                                        data-src="{{ asset('assets/images/products/mens/men-12.jpg') }}"
                                        src="{{ asset('assets/images/products/mens/men-12.jpg') }}" alt="image-product">
                                </a>
                                <div class="list-product-btn">
                                    <a href="javascript:void(0);" class="box-icon wishlist btn-icon-action">
                                        <span class="icon icon-heart"></span>
                        ...
                        <div class="fl-item card-product">
                            <div class="card-product-wrapper">
                                <a href="product-detail.html" class="product-img">
                                    <img class="lazyload img-product"
                                        data-src="{{ asset('assets/images/products/mens/men-13.jpg') }}"
                                        src="{{ asset('assets/images/products/mens/men-13.jpg') }}" alt="image-product">
                                    <img class="lazyload img-hover"
                                        data-src="{{ asset('assets/images/products/mens/men-14.jpg') }}"
                                        src="{{ asset('assets/images/products/mens/men-14.jpg') }}" alt="image-product">
                                </a>
                                <div class="on-sale-wrap"><span class="on-sale-item">-25%</span></div>
                                <div class="marquee-product bg-main">
                                    <div class="marquee-wrapper">
                            ...
                            <div class="card-product-info">
                                ...
                                <ul class="list-color-product">
                                    <li class="list-color-item color-swatch active">
                                        ...
                                        <img class="lazyload"
                                            data-src="{{ asset('assets/images/products/mens/men-13.jpg') }}"
                                            src="{{ asset('assets/images/products/mens/men-13.jpg') }}"
                                            alt="image-product">
                                    </li>
                                    <li class="list-color-item color-swatch">
                                        ...
                                        <img class="lazyload"
                                            data-src="{{ asset('assets/images/products/mens/men-12.jpg') }}"
                                            src="{{ asset('assets/images/products/mens/men-12.jpg') }}"
                                            alt="image-product">
                                    </li>
                                </ul>
                            </div>
                        ...
                        <div class="fl-item card-product card-product-size">
                            <div class="card-product-wrapper">
                                <a href="product-detail.html" class="product-img">
                                    <img class="lazyload img-product"
                                        data-src="{{ asset('assets/images/products/mens/men-7.jpg') }}"
                                        src="{{ asset('assets/images/products/mens/men-7.jpg') }}" alt="image-product">
                                    <img class="lazyload img-hover"
                                        data-src="{{ asset('assets/images/products/mens/men-8.jpg') }}"
                                        src="{{ asset('assets/images/products/mens/men-8.jpg') }}" alt="image-product">
                                </a>
                                <div class="on-sale-wrap"><span class="on-sale-item">-25%</span></div>
                                <div class="variant-wrap size-list">
                                    <ul class="variant-box">
                            ...
                            <div class="card-product-info">
                                ...
                                <ul class="list-color-product">
                                    <li class="list-color-item color-swatch active line">
                                        ...
                                        <img class="lazyload"
                                            data-src="{{ asset('assets/images/products/mens/men-7.jpg') }}"
                                            src="{{ asset('assets/images/products/mens/men-7.jpg') }}"
                                            alt="image-product">
                                    </li>
                                    <li class="list-color-item color-swatch">
                                        <span class="d-none text-capitalize color-filter">Grey</span>
                                        ...
                                        <img class="lazyload"
                                            data-src="{{ asset('assets/images/products/mens/men-11.jpg') }}"
                                            src="{{ asset('assets/images/products/mens/men-11.jpg') }}"
                                            alt="image-product">
                                    </li>
                        ...
                        <div class="fl-item card-product">
                            <div class="card-product-wrapper">
                                <a href="product-detail.html" class="product-img">
                                    <img class="lazyload img-product"
                                        data-src="{{ asset('assets/images/products/mens/men-1.jpg') }}"
                                        src="{{ asset('assets/images/products/mens/men-1.jpg') }}" alt="image-product">
                                    <img class="lazyload img-hover"
                                        data-src="{{ asset('assets/images/products/mens/men-3.jpg') }}"
                                        src="{{ asset('assets/images/products/mens/men-3.jpg') }}" alt="image-product">
                                </a>
                                <div class="list-product-btn">
                                    <a href="javascript:void(0);" class="box-icon wishlist btn-icon-action">
                                        <span class="icon icon-heart"></span>
                            ...
                            <div class="card-product-info">
                                ...
                                <ul class="list-color-product">
                                    <li class="list-color-item color-swatch active line">
                                        ...
                                        <img class="lazyload"
                                            data-src="{{ asset('assets/images/products/mens/men-1.jpg') }}"
                                            src="{{ asset('assets/images/products/mens/men-1.jpg') }}"
                                            alt="image-product">
                                    </li>
                                    <li class="list-color-item color-swatch">
                                        <span class="d-none text-capitalize color-filter">Pink</span>
                                    ...
                                    <li class="list-color-item color-swatch">
                                        ...
                                        <span class="swatch-value bg-dark-grey-2"></span>
                                        <img class="lazyload"
                                            data-src="{{ asset('assets/images/products/mens/men-9.jpg') }}"
                                            src="{{ asset('assets/images/products/mens/men-9.jpg') }}"
                                            alt="image-product">
                                    </li>
                                </ul>
                            </div>
                        ...
                        <div class="fl-item card-product card-product-size">
                            <div class="card-product-wrapper">
                                <a href="product-detail.html" class="product-img">
                                    <img class="lazyload img-product"
                                        data-src="{{ asset('assets/images/products/womens/women-37.jpg') }}"
                                        src="{{ asset('assets/images/products/womens/women-37.jpg') }}"
                                        alt="image-product">
                                    <img class="lazyload img-hover"
                                        data-src="{{ asset('assets/images/products/womens/women-38.jpg') }}"
                                        src="{{ asset('assets/images/products/womens/women-38.jpg') }}"
                                        alt="image-product">
                                </a>
                                <div class="variant-wrap size-list">
                                    <ul class="variant-box">
                            ...
                            <div class="card-product-info">
                                ...
                                <ul class="list-color-product">
                                    ...
                                    <li class="list-color-item color-swatch line">
                                        ...
                                        <span class="swatch-value bg-white"></span>
                                        <img class="lazyload"
                                            data-src="{{ asset('assets/images/products/womens/women-41.jpg') }}"
                                            src="{{ asset('assets/images/products/womens/women-41.jpg') }}"
                                            alt="image-product">
                                    </li>
                                </ul>
                            </div>
                        ...
                        <div class="fl-item card-product card-product-size">
                            <div class="card-product-wrapper">
                                <a href="product-detail.html" class="product-img">
                                    <img class="lazyload img-product"
                                        data-src="{{ asset('assets/images/products/mens/men-15.jpg') }}"
                                        src="{{ asset('assets/images/products/mens/men-15.jpg') }}" alt="image-product">
                                    <img class="lazyload img-hover"
                                        data-src="{{ asset('assets/images/products/mens/men-16.jpg') }}"
                                        src="{{ asset('assets/images/products/mens/men-16.jpg') }}" alt="image-product">
                                </a>
                                <div class="variant-wrap size-list">
                                    <ul class="variant-box">
                                        <li class="size-item">XS</li>
                            ...
                            <div class="card-product-info">
                                ...
                                <ul class="list-color-product">
                                    <li class="list-color-item color-swatch active">
                                        ...
                                        <img class="lazyload"
                                            data-src="{{ asset('assets/images/products/mens/men-15.jpg') }}"
                                            src="{{ asset('assets/images/products/mens/men-15.jpg') }}"
                                            alt="image-product">
                                    </li>
                                    <li class="list-color-item color-swatch">
                                        ...
                                        <img class="lazyload"
                                            data-src="{{ asset('assets/images/products/mens/men-18.jpg') }}"
                                            src="{{ asset('assets/images/products/mens/men-18.jpg') }}"
                                            alt="image-product">
                                    </li>
                                    <li class="list-color-item color-swatch">
                                        ...
                                        <img class="lazyload"
                                            data-src="{{ asset('assets/images/products/mens/men-17.jpg') }}"
                                            src="{{ asset('assets/images/products/mens/men-17.jpg') }}"
                                            alt="image-product">
                                    </li>
                                </ul>
                            </div>
                        ...
                        <div class="fl-item card-product">
                            <div class="card-product-wrapper">
                                <a href="product-detail.html" class="product-img">
                                    <img class="lazyload img-product"
                                        data-src="{{ asset('assets/images/products/womens/women-167.jpg') }}"
                                        src="{{ asset('assets/images/products/womens/women-167.jpg') }}"
                                        alt="image-product">
                                    <img class="lazyload img-hover"
                                        data-src="{{ asset('assets/images/products/womens/women-168.jpg') }}"
                                        src="{{ asset('assets/images/products/womens/women-168.jpg') }}"
                                        alt="image-product">
                                </a>
                                <div class="list-product-btn">
                                    <a href="javascript:void(0);" class="box-icon wishlist btn-icon-action">
                            ...
                            <div class="card-product-info">
                                ...
                                <ul class="list-color-product">
                                    ...
                                    <li class="list-color-item color-swatch">
                                        ...
                                        <span class="swatch-value bg-beige"></span>
                                        <img class="lazyload"
                                            data-src="{{ asset('assets/images/products/womens/women-162.jpg') }}"
                                            src="{{ asset('assets/images/products/womens/women-162.jpg') }}"
                                            alt="image-product">
                                    </li>
                        ...
                        <div class="fl-item card-product card-product-size">
                            <div class="card-product-wrapper">
                                <a href="product-detail.html" class="product-img">
                                    <img class="lazyload img-product"
                                        data-src="{{ asset('assets/images/products/mens/men-19.jpg') }}"
                                        src="{{ asset('assets/images/products/mens/men-19.jpg') }}" alt="image-product">
                                    <img class="lazyload img-hover"
                                        data-src="{{ asset('assets/images/products/mens/men-20.jpg') }}"
                                        src="{{ asset('assets/images/products/mens/men-20.jpg') }}" alt="image-product">
                                </a>
                                <div class="variant-wrap size-list">
                                    <ul class="variant-box">
                                        <li class="size-item">XS</li>
                    ...
                    <div class="row-demo">
                        <div class="demo-item">
                            <a href="index.html">
                                <div class="demo-image position-relative">
                                    <img class="lazyload"
                                        data-src="{{ asset('assets/images/demo/home-fashion-womenswear.jpg') }}"
                                        src="{{ asset('assets/images/demo/home-fashion-womenswear.jpg') }}"
                        ...
                        <div class="demo-item">
                            <a href="home-fashion-eleganceNest.html">
                                <div class="demo-image position-relative">
                                    <img class="lazyload"
                                        data-src="{{ asset('assets/images/demo/home-fashion-eleganceNest.jpg') }}"
                                        src="{{ asset('assets/images/demo/home-fashion-eleganceNest.jpg') }}"
                        ...
                        <div class="demo-item">
                            <a href="home-fashion-main.html">
                                <div class="demo-image position-relative">
                                    <img class="lazyload"
                                        data-src="{{ asset('assets/images/demo/home-fashion-main.jpg') }}"
                                        src="{{ asset('assets/images/demo/home-fashion-main.jpg') }}"
                        ...
                        <div class="demo-item">
                            <a href="home-fashion-trendset.html">
                                <div class="demo-image">
                                    <img class="lazyload"
                                        data-src="{{ asset('assets/images/demo/home-fashion-trendset.jpg') }}"
                                        src="{{ asset('assets/images/demo/home-fashion-trendset.jpg') }}"
                        ...
                        <div class="demo-item">
                            <a href="home-fashion-vogueLing.html">
                                <div class="demo-image">
                                    <img class="lazyload"
                                        data-src="{{ asset('assets/images/demo/home-fashion-vogueLiving.jpg') }}"
                                        src="{{ asset('assets/images/demo/home-fashion-vogueLiving.jpg') }}"
                        ...
                        <div class="demo-item">
                            <a href="home-fashion-elegantAbode.html">
                                <div class="demo-image">
                                    <img class="lazyload"
                                        data-src="{{ asset('assets/images/demo/home-fashion-elegantAbode.jpg') }}"
                                        src="{{ asset('assets/images/demo/home-fashion-elegantAbode.jpg') }}"
                        ...
                        <div class="demo-item">
                            <a href="home-fashion-glamDwell.html">
                                <div class="demo-image position-relative">
                                    <img class="lazyload"
                                        data-src="{{ asset('assets/images/demo/home-fashion-glamDwell.jpg') }}"
                                        src="{{ asset('assets/images/demo/home-fashion-glamDwell.jpg') }}"
                        ...
                        <div class="demo-item">
                            <a href="home-fashion-classyCove.html">
                                <div class="demo-image">
                                    <img class="lazyload"
                                        data-src="{{ asset('assets/images/demo/home-fashion-classycove.jpg') }}"
                                        src="{{ asset('assets/images/demo/home-fashion-classycove.jpg') }}"
                        ...
                        <div class="demo-item">
                            <a href="home-fashion-chicHaven.html">
                                <div class="demo-image">
                                    <img class="lazyload"
                                        data-src="{{ asset('assets/images/demo/home-fashion-chicHaven.jpg') }}"
                                        src="{{ asset('assets/images/demo/home-fashion-chicHaven.jpg') }}"
                        ...
                        <div class="demo-item">
                            <a href="home-fashion-chicHaven-02.html">
                                <div class="demo-image">
                                    <img class="lazyload"
                                        data-src="{{ asset('assets/images/demo/home-fashion-chicHaven2.jpg') }}"
                                        src="{{ asset('assets/images/demo/home-fashion-chicHaven2.jpg') }}"
                        ...
                        <div class="demo-item">
                            <a href="home-fashion-tiktok.html">
                                <div class="demo-image">
                                    <img class="lazyload"
                                        data-src="{{ asset('assets/images/demo/home-fashion-tiktok.jpg') }}"
                                        src="{{ asset('assets/images/demo/home-fashion-tiktok.jpg') }}"
                        ...
                        <div class="demo-item">
                            <a href="home-fashion-luxeLiving.html">
                                <div class="demo-image">
                                    <img class="lazyload"
                                        data-src="{{ asset('assets/images/demo/home-fashion-luxeLiving.jpg') }}"
                                        src="{{ asset('assets/images/demo/home-fashion-luxeLiving.jpg') }}"
                        ...
                        <div class="demo-item">
                            <a href="home-fashion-modernRetreat.html">
                                <div class="demo-image">
                                    <img class="lazyload"
                                        data-src="{{ asset('assets/images/demo/home-fashion-modernRetreat.jpg') }}"
                                        src="{{ asset('assets/images/demo/home-fashion-modernRetreat.jpg') }}"
                        ...
                        <div class="demo-item">
                            <a href="home-beauty.html">
                                <div class="demo-image">
                                    <img class="lazyload" data-src="{{ asset('assets/images/demo/home-beauty.jpg') }}"
                                        src="{{ asset('assets/images/demo/home-beauty.jpg') }}" alt="home-beauty">
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-skincare.html">
                                <div class="demo-image">
                                    <img class="lazyload" data-src="{{ asset('assets/images/demo/home-skinCare.jpg') }}"
                                        src="{{ asset('assets/images/demo/home-skinCare.jpg') }}" alt="home-skincare">
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-cosmetic.html">
                                <div class="demo-image">
                                    <img class="lazyload" data-src="{{ asset('assets/images/demo/home-cosmetic.jpg') }}"
                                        src="{{ asset('assets/images/demo/home-cosmetic.jpg') }}" alt="home-cosmetic">
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-decor.html">
                                <div class="demo-image">
                                    <img class="lazyload" data-src="{{ asset('assets/images/demo/home-decor.jpg') }}"
                                        src="{{ asset('assets/images/demo/home-decor.jpg') }}" alt="home-decor">
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-furniture.html">
                                <div class="demo-image">
                                    <img class="lazyload"
                                        data-src="{{ asset('assets/images/demo/home-furniture.jpg') }}"
                                        src="{{ asset('assets/images/demo/home-furniture.jpg') }}" alt="home-furniture">
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-jewelry-01.html">
                                <div class="demo-image">
                                    <img class="lazyload" data-src="{{ asset('assets/images/demo/home-jewelry.jpg') }}"
                                        src="{{ asset('assets/images/demo/home-jewelry.jpg') }}"
                        ...
                        <div class="demo-item">
                            <a href="home-jewelry-02.html">
                                <div class="demo-image">
                                    <img class="lazyload" data-src="{{ asset('assets/images/demo/home-jewelry2.jpg') }}"
                                        src="{{ asset('assets/images/demo/home-jewelry2.jpg') }}"
                        ...
                        <div class="demo-item">
                            <a href="home-activewear.html">
                                <div class="demo-image">
                                    <img class="lazyload"
                                        data-src="{{ asset('assets/images/demo/home-activewear.jpg') }}"
                                        src="{{ asset('assets/images/demo/home-activewear.jpg') }}"
                                        alt="home-activewear">
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-organic.html">
                                <div class="demo-image">
                                    <img class="lazyload" data-src="{{ asset('assets/images/demo/home-organic.jpg') }}"
                                        src="{{ asset('assets/images/demo/home-organic.jpg') }}" alt="home-organic">
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-sock.html">
                                <div class="demo-image">
                                    <img class="lazyload" data-src="{{ asset('assets/images/demo/home-sock.jpg') }}"
                                        src="{{ asset('assets/images/demo/home-sock.jpg') }}" alt="home-sock">
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-camping.html">
                                <div class="demo-image">
                                    <img class="lazyload" data-src="{{ asset('assets/images/demo/home-camping.jpg') }}"
                                        src="{{ asset('assets/images/demo/home-camping.jpg') }}" alt="home-camping">
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-electronic.html">
                                <div class="demo-image">
                                    <img class="lazyload"
                                        data-src="{{ asset('assets/images/demo/home-electronic.jpg') }}"
                                        src="{{ asset('assets/images/demo/home-electronic.jpg') }}"
                                        alt="home-electronic">
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-pet-store.html">
                                <div class="demo-image">
                                    <img class="lazyload"
                                        data-src="{{ asset('assets/images/demo/home-pet-store.jpg') }}"
                                        src="{{ asset('assets/images/demo/home-pet-store.jpg') }}" alt="home-pet-store">
                                </div>
                                        ...
                                        <div id="sub-shop-one" class="collapse">
                                            <ul class="sub-nav-menu sub-menu-level-2">
                                                <li><a href="shop-default-grid.html" class="sub-nav-link">Default
                                                        Grid</a></li>
                                                <li><a href="shop-default-list.html" class="sub-nav-link">Default
                                                        List</a></li>
                ...
                <div class="bottom-bar-language">
                    <div class="tf-currencies">
                        <select class="image-select center style-default type-currencies">
                            <option selected data-thumbnail="images/country/bd.svg">BDT</option>
            ...
            <div class="canvas-body">
                <div class="wd-facet-categories">
                    <div role="dialog" class="facet-title collapsed" data-bs-target="#forWomen"
                        ...
                        <img class="avt" src="{{ asset('assets/images/avatar/women.jpg') }}" alt="avt">
                        ...
                        <ul class="facet-body">
                            <li>
                                <a href="#" class="item link"><img class="avt"
                                        src="{{ asset('assets/images/avatar/new-in.jpg') }}" alt="avt"><span
                                        class="title-sub text-caption-1 text-secondary">New in</span></a>
                            </li>
                            <li>
                                <a href="#" class="item link"><img class="avt"
                                        src="{{ asset('assets/images/avatar/promotion.jpg') }}" alt="avt"><span
                                        class="title-sub text-caption-1 text-secondary">Promotion</span></a>
                            </li>
                            <li>
                                <a href="#" class="item link"><img class="avt"
                                        src="{{ asset('assets/images/avatar/clothing.jpg') }}" alt="avt"><span
                                        class="title-sub text-caption-1 text-secondary">Clothing</span></a>
                            </li>
                            <li>
                                <a href="#" class="item link"><img class="avt"
                                        src="{{ asset('assets/images/avatar/shoes.jpg') }}" alt="avt"><span
                                        class="title-sub text-caption-1 text-secondary">Shoes</span></a>
                            </li>
                            <li>
                                <a href="#" class="item link"><img class="avt"
                                        src="{{ asset('assets/images/avatar/bags.jpg') }}" alt="avt"><span
                                        class="title-sub text-caption-1 text-secondary">Bags</span></a>
                            </li>
                            <li>
                                <a href="#" class="item link"><img class="avt"
                                        src="{{ asset('assets/images/avatar/accessories.jpg') }}" alt="avt"><span
                                        class="title-sub text-caption-1 text-secondary">Accessories</span></a>
                            </li>
                            <li>
                                <a href="#" class="item link"><img class="avt"
                                        src="{{ asset('assets/images/avatar/jewelry.jpg') }}" alt="avt"><span
                ...
                <div class="wd-facet-categories">
                    <div role="dialog" class="facet-title collapsed" data-bs-target="#forMen" data-bs-toggle="collapse"
                        ...
                        <img class="avt" src="{{ asset('assets/images/avatar/men.jpg') }}" alt="avt">
                    ...
                    <div id="forMen" class="collapse">
                        <ul class="facet-body">
                            <li>
                                <a href="#" class="item link"><img class="avt"
                                        src="{{ asset('assets/images/avatar/men.jpg') }}" alt="avt"><span
                ...
                <div class="wd-facet-categories">
                    <div role="dialog" class="facet-title collapsed" data-bs-target="#forKid" data-bs-toggle="collapse"
                        ...
                        <img class="avt" src="{{ asset('assets/images/avatar/kid.jpg') }}" alt="avt">
                    ...
                    <div id="forKid" class="collapse">
                        <ul class="facet-body">
                            <li>
                                <a href="#" class="item link"><img class="avt"
                                        src="{{ asset('assets/images/avatar/kid.jpg') }}" alt="avt"><span
                ...
                <div class="wd-facet-categories">
                    <div role="dialog" class="facet-title collapsed" data-bs-target="#accessories"
                        ...
                        <img class="avt" src="{{ asset('assets/images/avatar/accessories.jpg') }}" alt="avt">
                    ...
                    <div class="wrap-recommendations">
                        <div class="list-cart">
                            ...
                            <div class="list-cart-item">
                                <div class="image">
                                    <img class="lazyload"
                                        data-src="{{ asset('assets/images/products/womens/women-4.jpg') }}"
                                        src="{{ asset('assets/images/products/womens/women-4.jpg') }}" alt="">
                                </div>
                                <div class="content">
                                    <div class="name">
                            ...
                            <div class="list-cart-item">
                                <div class="image">
                                    <img class="lazyload"
                                        data-src="{{ asset('assets/images/products/womens/women-5.jpg') }}"
                                        src="{{ asset('assets/images/products/womens/women-5.jpg') }}" alt="">
                                </div>
                                <div class="content">
                                    <div class="name">
                                        <a class="link text-line-clamp-1" href="product-detail.html">Belt wrap dress</a>
                            ...
                            <div class="list-cart-item">
                                <div class="image">
                                    <img class="lazyload"
                                        data-src="{{ asset('assets/images/products/womens/women-6.jpg') }}"
                                        src="{{ asset('assets/images/products/womens/women-6.jpg') }}" alt="">
                                </div>
                                <div class="content">
                                    <div class="name">
                                        <a class="link text-line-clamp-1" href="product-detail.html">Belt wrap dress</a>
                                    ...
                                    <div class="tf-mini-cart-items">
                                        ...
                                        <div class="tf-mini-cart-item file-delete">
                                            <div class="tf-mini-cart-image">
                                                <img class="lazyload"
                                                    data-src="{{ asset('assets/images/products/womens/women-4.jpg') }}"
                                                    src="{{ asset('assets/images/products/womens/women-4.jpg') }}"
                                                    alt="">
                                            </div>
                                            <div class="tf-mini-cart-info flex-grow-1">
                                                <div
                                ...
                                <div class="tf-mini-cart-tool-content">
                                    ...
                                    <form class="form-estimate-shipping tf-mini-cart-tool-wrap">
                                        ...
                                        <fieldset class="">
                                            ...
                                            <input class="" type="text" placeholder="100000" name="text" tabindex="2"
                                                value="" aria-required="true" required="">
                                        </fieldset>
                                        <div class="tf-cart-tool-btns">
                                            <button type="submit" class="btn-style-2 w-100"><span
                                ...
                                <div class="tf-mini-cart-tool-content">
                                    ...
                                    <form class="form-add-coupon tf-mini-cart-tool-wrap">
                                        <fieldset class="">
                                            ...
                                            <input class="" type="text" placeholder="Discount code" name="text"
                                ...
                                <div class="tf-compare-wrap">
                                    ...
                                    <div class="tf-compare-item file-delete">
                                        ...
                                        <a href="product-detail.html" class="image">
                                            <img class="lazyload"
                                                data-src="{{ asset('assets/images/products/womens/women-29.jpg') }}"
                                                src="{{ asset('assets/images/products/womens/women-29.jpg') }}" alt="">
                                        </a>
                                        <div class="content">
                                            <div class="text-title">
                ...
                <div>
                    <div class="tf-product-info-list">
                        <div class="tf-product-info-item">
                            <div class="image">
                                <img src="{{ asset('assets/images/products/womens/women-1.jpg') }}" alt="">
                            </div>
                            <div class="content">
